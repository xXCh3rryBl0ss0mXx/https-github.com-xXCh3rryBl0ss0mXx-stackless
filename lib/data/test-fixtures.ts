import type { Invoice, Lead, Nudge, StoreSnapshot } from "./types";
...
export function fixtureSnapshot(overrides?: Partial<StoreSnapshot>): StoreSnapshot {
  return {
    leads: structuredClone(fixtureLeads),
    invoices: structuredClone(fixtureInvoices),
    nudges: structuredClone(fixtureNudges),
    ...overrides,
  };
}
